...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="{{ route('machines.import-form') }}" class="btn btn-info btn-sm">
                <i class="bi bi-upload"></i> Import Excel
            </a>
            <a href="{{ route('machines.create') }}" class="btn btn-success btn-sm">
                <i class="bi bi-plus-circle"></i> Tambah Mesin
            </a>
            <a href="{{ route('machines.template') }}" class="btn btn-primary btn-sm" title="Download template untuk import data">
