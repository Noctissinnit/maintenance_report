...
<div class="card">
    <div class="card-header">
        <h4 class="mb-0">Import Data Mesin</h4>
    </div>
    <div class="card-body">
        <div class="alert alert-info">
            <strong>Petunjuk Import:</strong>
            <ol>
                <li><a href="{{ route('templates.download-machine') }}" class="alert-link" download>Download template XLSX</a> terlebih dahulu</li>
                <li>Buka file dengan Excel dan isi data sesuai format (Nama Mesin, Line, Deskripsi, Status)</li>
