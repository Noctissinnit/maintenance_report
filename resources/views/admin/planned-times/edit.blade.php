...
document.addEventListener('DOMContentLoaded', () => {
    // Note: in edit mode, we don't automatically override the loaded planned_time_minutes value unless date inputs are modified.
    // So we just update the hours display initially.
    updateHours();
});
</script>
@endsection
