...
@section('content')
<h2 class="mb-4">Supervisor Dashboard - Monitoring Maintenance</h2>
...
<div class="row mb-4">
    <div class="col-md-12">
        <a href="{{ route('laporan.create') }}" class="btn btn-primary btn-lg" title="Buat laporan seperti operator">
